...
export default function OnlineScreen({ sceneManager, initialRaceGender, onExit }: OnlineScreenProps) {
  ...
  useEffect(() => {
    const onlineScene = new OnlineScene(sceneManager.renderer, initialRaceGender, {
  ...
  }, [sceneManager, initialRaceGender]);
